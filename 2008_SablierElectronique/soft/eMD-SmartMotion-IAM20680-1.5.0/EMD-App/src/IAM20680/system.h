...
#define SERIF_TYPE_I2C              0  /* For I2C, configure J2 pin [1==2(closed), 3==4(closed)] on TDK SmartMotion Board */

/* Select whether to use onboard/inbuilt sensor or external DB/EVB */
#define TDK_BOARD_INBUILT_SENSOR    1  /* Set 0 for external, 1 for in-built sensor on TDK SmartMotion Board */

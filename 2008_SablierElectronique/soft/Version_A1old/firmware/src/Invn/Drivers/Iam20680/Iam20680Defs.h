...
#define HW_IAM20680 0x1e
#define MEMS_CHIP  HW_IAM20680
...
#define MPUREG_LP_MODE_CONFIG     0x1E
...
********************************************/
/**
  * @brief  CONFIG Reg FIFO_COUNT_MODE Bit enumeration
  */
typedef enum
{
  IAM20680_CONFIG_FIFO_COUNT_REC_RECORD = 0x80, /*!< record mode */
  IAM20680_CONFIG_FIFO_COUNT_REC_BYTE   = 0x00, /*!< byte mode */
} IAM20680_CONFIG_FIFO_COUNT_REC_t;
#define BIT_FIFO_COUNT_REC_MASK          0x80
#define BIT_FIFO_COUNT_REC_POS              7
...
/**
  * @brief  ACCEL_CONFIG Reg FS_SEL Bits enumeration
  */
typedef enum
{
  IAM20680_ACCEL_CONFIG_FS_SEL_2g       = 0x00, /*!< gyro full scale range = +/-2g */
  IAM20680_ACCEL_CONFIG_FS_SEL_4g       = 0x08, /*!< gyro full scale range = +/-4g */
  IAM20680_ACCEL_CONFIG_FS_SEL_8g       = 0x10, /*!< gyro full scale range = +/-8g */
  IAM20680_ACCEL_CONFIG_FS_SEL_16g      = 0x18, /*!< gyro full scale range = +/-16g */
...
typedef enum
{
  ...
  IAM20680_FIFO_EN_TEMP_FIFO_EN_disable     = 0x00, /*!< enable temp in FIFO */
...
typedef enum
{
  ...
  IAM20680_ACCEL_INTEL_CTRL_ACCEL_INTEL_MODE_do_not_use    = 0x00, /*!< do not use */
...
#define BIT_OUTPUT_LIMIT_MASK            0x02

/**
  * @brief  ACCEL_INTEL_CTRL Reg WOM_TH_MODE Bit enumeration
  */
typedef enum
{
  IAM20680_ACCEL_INTEL_CTRL_WOM_TH_MODE_and   = 0x01, /*!< set WoM interrupt on the AND of all enabled accelerometer thresholds */
  IAM20680_ACCEL_INTEL_CTRL_WOM_TH_MODE_or    = 0x00, /*!< set WoM interrupt on the OR of all enabled accelerometer thresholds */
} IAM20680_ACCEL_INTEL_CTRL_WOM_TH_MODE_t;
#define BIT_WOM_TH_MODE_MASK             0x01
...
/**
  * @brief  PWR_MGMT_1 Reg CYCLE Bit enumeration
  */
typedef enum
{
  IAM20680_PWR_MGMT_1_CYCLE_on         = 0x20, /*!< enable accel low power mode */
  IAM20680_PWR_MGMT_1_CYCLE_off        = 0x00, /*!< disable accel low power mode */
} IAM20680_PWR_MGMT_1_CYCLE_t;
#define BIT_CYCLE_MASK                   0x20
...
/**
  * @brief  IAM20680_LP_MODE_CONFIG_LPOSC_CLKSEL_t structure definition
  */
typedef struct {
	int idx;		/*!< LPOSC_CLKSEL index */
	double odr_hz;  /*!< Output Frequency in Hz */
} IAM20680_LP_MODE_CONFIG_LPOSC_CLKSEL_t;

...
#define APP_USB_USB_SWITCH_DEBOUNCE_COUNT_FS (260)
#define APP_USB_USB_SWITCH_DEBOUNCE_COUNT_HS (260)

/* Application USB Device CDC Read Buffer Size. This should be a multiple of
 * the CDC Bulk Endpoint size */

#define APP_USB_READ_BUFFER_SIZE 64

/* Macro defines USB internal DMA Buffer criteria*/

#define APP_USB_MAKE_BUFFER_DMA_READY
/*** Application Instance 0 Configuration ***/

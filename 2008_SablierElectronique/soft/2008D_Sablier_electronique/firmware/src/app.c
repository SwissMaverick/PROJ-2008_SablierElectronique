...
//            SPI_InitIAM();//initialisation du SPI pour le IAM
            ...
            Config_IO_AOff(); //Allume toutes les lignes
            Config_IO_BOff(); //Allume toutes les lignes
            AMatriceONOff();  //Allume toutes les lignes
            BMatriceONOff();  //Allume toutes les lignes

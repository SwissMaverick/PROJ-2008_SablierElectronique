...
/** @defgroup InvStatus Status code
 *	@brief    Common status code
 *
 *	@ingroup EmbUtils
 *	@{
 */

#ifndef _INV_STATUS_H_
#define _INV_STATUS_H_

/** @brief Common status code definition
 */
enum inv_status
{
	INV_SUCCESS             = 0,   /**< no error */
